  ...
  const resp = await fetch('https://gql.twitch.tv/gql', {
    ...
    body: JSON.stringify({
      query:
        'query { video(id: "' +
        vodID +
        '") { broadcastType, createdAt, seekPreviewsURL, owner { login }, playbackAccessToken(params: {platform: "web", playerType: "site", maximum_resolution: "HD"}) { authorization { isForbidden } } }}'
    }),
    headers: {
